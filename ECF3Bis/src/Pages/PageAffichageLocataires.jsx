    ...
    return (
        <>
            ...
            <div className="displayAddButton">
                ...
                {isDisplayed ? <> <CompAddLocataire setIsDisplayed={setIsDisplayed} addLocataires={addLocataires} getLocataires={getLocataires} />  <Button variant="danger" onClick={handleClichShow}>-</Button></> : <Button variant="success" onClick={handleClichShow}>+</Button>}
            </div>
            <div className="displayCardLocataires">
                {locatairesList.map((locataire, key) => { return <CompAffichageLocataire locataire={locataire} key={locataire.id} deleteLocataire={deleteLocataire} getLocataires={getLocataires} /> })}
            </div>
        </>
    )
}
