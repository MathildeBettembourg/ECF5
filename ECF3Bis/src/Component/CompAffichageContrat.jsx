          ...
          <Card.Body>
            <blockquote className="blockquote mb-0">
              <Card.Title>Contrat</Card.Title>
                            <Card.Text> Nom : {props.contrat.locataire.nom}</Card.Text>
                            <Card.Text>Prenom : {props.contrat.locataire.prenom}</Card.Text>
                            <Card.Text> Voiture : {props.contrat.vehicule.modele}</Card.Text>
                            <Card.Text>Type de vehicule : {props.contrat.vehicule.type}</Card.Text>
                            <Card.Text>Debut : {props.contrat.fullstart}</Card.Text>
                            <Card.Text>Fin : {props.contrat.fullend}</Card.Text>
                            {/* envoyer en btn */}
